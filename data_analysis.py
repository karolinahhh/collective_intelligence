...
for i, df in enumerate(dataframes):
    ...
    # radius += 10
    plt.plot(grouped_df.index, grouped_df[0.5], label=f'Median of radius {i}')
...
plt.legend()
plt.title('Proportion Over Time in the Four Food Segments environment for radius 10')
plt.grid(True)
